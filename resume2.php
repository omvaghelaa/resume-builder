...
.page {
    width: 90%;
    max-width: 35cm; /* Increased from 30cm to 35cm */
    min-height: 29.7cm;
    padding: 0.5cm;
    margin: 0.5cm auto;
...
.experience-box {
    flex: 1 1 calc(50% - 20px); /* Adjusts width to 50% minus the gap */
    box-sizing: border-box;

    border: 1px solid #ccc; /* Customize the border color */
    padding: 15px; /* Add padding inside the border */
    margin-bottom: 10px; /* Space between experience boxes */
    border-radius: 5px; /* Optional: rounded corners */
    margin-left:5px;
    box-shadow: 2px 2px 10px rgba(0, 0, 0, 0.1); /* Optional: box shadow for better appearance */
}
                ...
                <div class="left_Side">
                    <div class="profileText">
                        ...
                        <h2 style="font-family:<?= $resume['font'] ?>">
                            <?= $resume['full_name'] ?><br><span><?= $resume['profession'] ?></span></h2>
                    </div>
                    ...
                    <div class="contactInfo">
                        ...
                        <ul>
                            ...
                            <li>
                                ...
                                <span class="text"
                                    style="font-family:<?= $resume['font'] ?>">My WebSite</span>
                            </li>
                            <li>
                                <span class="icon"><i class="fa fa-linkedin" aria-hidden="true"></i></span>
                                <span class="text"
                                    style="font-family:<?= $resume['font'] ?>">LinkedIn</span>
                            </li>
                            <li>
                        ...
                        <ul>
                            ...
                            if ($edus) {
                                foreach ($edus as $edu) {
                                    ?>
                                    <li>
                                        <h5 style="font-family:<?= $resume['font'] ?>"><?= $edu['started'] ?> – <?= $edu['ended'] ?>
                                        </h5>
            ...
            <?php foreach ($exps as $exp): ?>
                <div class="experience-box">
                    <div class="year_company">
                        <h5 style="font-family:<?= $resume['font'] ?>; font-size:15px;"><?= $exp['started'] ?> – <?= $exp['ended'] ?></h5>
                        <h5 style="font-family:<?= $resume['font'] ?>; font-size:18px;"><?= $exp['company'] ?></h5>
                    </div>
                    <div class="text">
                        <h4 style="font-family:<?= $resume['font'] ?>; padding-left:10px;"><?= $exp['position'] ?></h4>
                        <p style="font-family:<?= $resume['font'] ?>; padding-left:10px;"><?= $exp['job_desc'] ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
    ...
    <div class="experience-container">
        <?php if ($ache): ?>
            <?php foreach ($ache as $ach): ?>
                <div class="experience-box">
                    <div class="year_company">
                        <h5 style="font-family:<?= $resume['font'] ?>; font-size:15px;"><?= $ach['ach_title'] ?></h5>
                        <h5 style="font-family:<?= $resume['font'] ?>; font-size:18px;"><?= $ach['organization'] ?></h5>
                    </div>
                    <div class="text">
                        
                        <p style="font-family:<?= $resume['font'] ?>; padding-left:10px;"><?= $ach['ach_desc'] ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
    ...
    <div class="experience-container">
        <?php if ($proj): ?>
            <?php foreach ($proj as $prj): ?>
                <div class="experience-box">
                    <div class="year_company">
                        <h5 style="font-family:<?= $resume['font'] ?>; font-size:15px;"><?= $prj['prj_title'] ?></h5>
                        <h5 style="font-family:<?= $resume['font'] ?>; font-size:18px;"><?= $prj['prj_role'] ?></h5>
                    </div>
                    <div class="text">
                        <a href="<?=$prj['prj_url']?>" style="font-family:<?= $resume['font'] ?>; padding-left:10px;"><?=$prj['prj_url']?></a>
                        <p style="font-family:<?= $resume['font'] ?>; padding-left:10px;"><?= $prj['prj_desc'] ?></p>
                    </div>
                </div>
            <?php endforeach; ?>
        <?php else: ?>
        ...
        <?php endif; ?>
                ...
                <div class="About interest">
                    ...
                    <ul>
                        <li style="font-family:<?= $resume['font'] ?>"><i class="fa fa-briefcase" aria-hidden="true"></i>
                            <?= $resume['hobbies'] ?></li>
                    </ul>
                    
                </div>
                <div style="padding-top:20px;">
                <label class="fw-bold align-top text-nowrap pr title" style="font-size: 20px;">Declaration</label>
    ...
    <div class="offcanvas offcanvas-bottom" tabindex="-1" id="font" aria-labelledby="offcanvasBottomLabel">
        ...
        <div class="offcanvas-body">
            <select class="form-control" id="font">
                ...
                <option value="'Playpen Sans', cursive" <?= $resume['font'] == "'Playpen Sans', cursive" ? 'selected' : '' ?>
                    style="font-family: 'Playpen Sans', cursive;">'Playpen Sans', cursive</option>
                ...
                <option value="'Comfortaa', sans-serif" <?= $resume['font'] == "'Comfortaa', sans-serif" ? 'selected' : '' ?>
                    style="font-family: 'Comfortaa', sans-serif;">'Comfortaa', sans-serif</option>
                ...
                <option value="'Fira Sans', sans-serif" <?= $resume['font'] == "'Fira Sans', sans-serif" ? 'selected' : '' ?>
                    style="font-family: 'Fira Sans', sans-serif;">'Fira Sans', sans-serif</option>
                ...
                <option value="'Montserrat', sans-serif" <?= $resume['font'] == "'Montserrat', sans-serif" ? 'selected' : '' ?>
                    style="font-family: 'Montserrat', sans-serif;">'Montserrat', sans-serif</option>
