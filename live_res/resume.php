...
<html>
    <head>
        ...
        <!-- custom css -->
        <link rel="stylesheet" href="../assets/live_assets/css/main.css">
    </head>
    <body>
    ...
    <div id="popup" class="popup">
                ...
                <div class = "navbar-content">
                    <div class = "brand-and-toggler">
                        <a href = "index.html" class = "navbar-brand">
                            <img src = "../assets/live_assets/images/curriculum-vitae.png" alt = "" class = "navbar-brand-icon">
        ...
        <section id = "about-sc" class = "">
            <div class = "container">
                <div class = "about-cnt">
                <form action="php/save_resume.php" class="cv-form" id="cv-form" method="post" enctype="multipart/form-data">
    ...
    <div class="cv-form-row cv-form-row-skills">
        <div class="form-elem mb-3 w-100">
            <label for="full_name" class="form-label">Full Name</label>
            <input name="full_name" type="text" class="form-control form-control-sm" id="full_name" onkeyup="generateCV()" placeholder="e.g. John">
            <span class="form-text"></span>
                                ...
                                <div class = "cols-3">
                                    ...
                                    <div class="form-elem">
                                        ...
                                        <input name="summary" id="summary" type="text" class="form-control summary" placeholder="e.g. Doe">
                                        <button type="button" onclick="generateResponse('summary','summ_txtarea')">Improve</button>
                                        <button type="button" onclick="realgenerateResponse('summary','summ_txtarea')" style="margin-left:20rem;">Generate</button>
                            ...
                            <div class="form-group">
                                <textarea class="form-control mt-3" id="summ_txtarea" rows="4" placeholder="Improved achievement description will appear here..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="cv-form-blk">
                                        ...
                                        <div class = "cv-form-row cv-form-row-achievement">
                                            <div class = "cols-2">
                                                ...
                                                <div class = "form-elem">
                                                    ...
                                                    <input name = "achieve_description" id="achieve_description" type = "text" class = "form-control achieve_description" id = "" onkeyup="generateCV()" placeholder="e.g. johndoe@gmail.com">
                                                    <span class="form-text"></span>
                                                    <button type="button" onclick="generateResponse('achieve_description','ach_txtarea')">Improve</button>
                                                    <button type="button" onclick="realgenerateResponse('achieve_description','ach_txtarea')" style="margin-left:39rem;">Generate</button>
                                                </div>
                                            </div>
                            ...
                            <div class="form-group">
                                <textarea class="form-control mt-3" id="ach_txtarea" rows="4" placeholder="Improved achievement description will appear here..."></textarea>
                        ...
                        <div class="cv-form-blk">
                                    ...
                                    <div data-repeater-item>
                                        <div class = "cv-form-row cv-form-row-experience">
                                            ...
                                            <div class = "cols-3">
                                                ...
                                                <div class = "form-elem">
                                                    <label for = "" class = "form-label">Description</label>
                                                    <input name = "exp_description" id="exp_description" type = "text" class = "form-control exp_description" id = "" onkeyup="generateCV()">
                                                    <span class="form-text"></span>
                                                    <button type="button" onclick="generateResponse('exp_description','exp_txtarea')">Improve</button>
                                                    <button type="button" onclick="realgenerateResponse('exp_description','exp_txtarea')" style="margin-left:20rem;">Generate</button>
                            ...
                            <div class="form-group">
                                <textarea class="form-control mt-3" id="exp_txtarea" rows="4" placeholder="Improved achievement description will appear here..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="cv-form-blk">
                                    ...
                                    <div data-repeater-item>
                                        <div class = "cv-form-row cv-form-row-experience">
                                            ...
                                            <div class = "cols-3">
                                                ...
                                                <div class = "form-elem">
                                                    <label for = "" class = "form-label">Description</label>
                                                    <input name = "edu_description" id="edu_description" type = "text" class = "form-control edu_description" id = "" onkeyup="generateCV()">
                                                    <span class="form-text"></span>
                                                    <button type="button" onclick="generateResponse('edu_description','edu_txtarea')">Improve</button>
                                                    <button type="button" onclick="realgenerateResponse('edu_description','edu_txtarea')" style="margin-left:20rem;">Generate</button>
                            ...
                            <div class="form-group">
                                <textarea class="form-control mt-3" id="edu_txtarea" rows="4" placeholder="Improved achievement description will appear here..."></textarea>
                            </div>
                        </div>
                        ...
                        <div class="cv-form-blk">
                                    ...
                                    <div data-repeater-item>
                                        <div class = "cv-form-row cv-form-row-experience">
                                            <div class = "cols-3">
                                                ...
                                                <div class = "form-elem">
                                                    <label for = "" class = "form-label">Description</label>
                                                    <input name = "proj_description" id="proj_description" type = "text" class = "form-control proj_description" id = "" onkeyup="generateCV()">
                                                    <span class="form-text"></span>
                                                    <button type="button" onclick="generateResponse('proj_description','prj_txtarea')">Improve</button>
                                                    <button type="button" onclick="realgenerateResponse('proj_description','prj_txtarea')" style="margin-left:20rem;">Generate</button>
                            ...
                            <div class="form-group">
                                <textarea class="form-control mt-3" id="prj_txtarea" rows="4" placeholder="Improved achievement description will appear here..."></textarea>
                            </div>
                        </div>
        ...
        <section class = "print-btn-sc">
            <div class = "container">
                <input type = "submit" class = "print-btn btn btn-primary">
            </div>
        </section> 
        ...
        <!-- custom js -->
        <script src = "../assets/live_assets/js/script.js"></script>
        <!-- app js -->
        <script src="../assets/live_assets/js/app.js"></script>
        <script src="../assets/live_assets/js/scr.js"></script>
        <script src="../assets/live_assets/js/generate.js"></script>
    </body>
</html>